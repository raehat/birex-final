      ...
      <div className="lg:hidden flex flex-col gap-2 p-3" style={{ background: 'var(--bg-card)' }}>
        ...
        {activeBet ? (
          <div className="flex items-center justify-between px-3 py-3 rounded-xl"
               style={{
                 background: activeBet.direction === 'up' ? 'rgba(0,255,136,0.08)' : 'rgba(255,51,86,0.08)',
                 border: `1px solid ${activeBet.direction === 'up' ? 'rgba(0,255,136,0.25)' : 'rgba(255,51,86,0.25)'}`,
               }}>
            <div className="flex flex-col gap-0.5">
              <span className="text-xs font-bold" style={{ color: 'rgba(255,255,255,0.4)' }}>TRADE ACTIVE</span>
              <span className="text-sm font-bold" style={{ color: activeBet.direction === 'up' ? '#00ff88' : '#ff3356' }}>
            ...
            <div className="font-black leading-none" style={{ color: activeBet.direction === 'up' ? '#00ff88' : '#ff3356', fontSize: '2.25rem' }}>
        ...
        {resultVisible && result && (
          <div className={`rounded-xl p-3 text-center font-black text-base ${result === 'win' ? 'win-glow' : ''}`}
               style={{
            ...
            {result === 'win' ? `🎉 WIN! +$${potentialWin}` : `❌ LOSE -$${amount}`}
          </div>
        )}
      </div>
